...
const AuditLogPage = () => {
  ...
  const fetchLogs = async () => {
    try {
      ...
      // Demo mock data
      setLogs([
        { id: 1, event: 'USER_LOGIN', user: 'viraj@cherriplus.local', detail: 'Successful login from IP 192.168.1.1', severity: 'INFO', time: '5 min ago' },
        ...
        { id: 4, event: 'USER_INVITED', user: 'viraj@cherriplus.local', detail: 'Sent invitation to sarah@pharma.com', severity: 'INFO', time: 'Yesterday' },
        { id: 5, event: 'AUTH_FAILED', user: 'unknown', detail: '3 failed login attempts for admin@cherriplus.com', severity: 'ERROR', time: '2 days ago' },
      ]);
    } finally {
      setIsLoading(false);
    }
